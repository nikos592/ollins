  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-32 h-32 md:w-64 md:h-64 opacity-10">
        <div className="w-full h-full bg-gradient-to-br from-purple-200 to-pink-200 rounded-full transform translate-x-16 -translate-y-16 md:translate-x-32 md:-translate-y-32"></div>
      </div>
      <div className="absolute bottom-0 left-0 w-48 h-48 md:w-96 md:h-96 opacity-10">
        <div className="w-full h-full bg-gradient-to-tr from-purple-200 to-pink-200 rounded-full transform -translate-x-24 translate-y-24 md:-translate-x-48 md:translate-y-48"></div>
      </div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 relative z-10">
        {/* Masters Grid - Responsive Layout */}
        <div className="flex flex-col lg:flex-row justify-start items-stretch max-w-[1201px] mx-auto gap-4 lg:gap-6">
          {/* Master Card - Full width on mobile, 1/3 on desktop */}
          ...
          {/* Reviews Section - Full width on mobile, 2/3 on desktop */}
          <div className="w-full lg:w-2/3 flex flex-col lg:items-end">
            <ReviewsParser />
          </div>
        </div>
      </div>
