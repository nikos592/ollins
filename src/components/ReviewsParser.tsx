         ...
         {reviews.map((review, index) => (
           ...
           >
             <div className="flex items-start justify-between mb-2">
                 ...
                 <div className="w-6 h-6 bg-gradient-to-r from-pink-400 to-purple-500 rounded-full flex items-center justify-center text-white font-semibold text-xs">
                   {review.author.charAt(0)}
                 </div>
                 <span className="font-semibold text-gray-800 font-montserrat text-sm">
                   {review.author}
                 </span>
               </div>
                <div className="flex">
                  {renderStars(review.rating)}
                          ...
                          <p className="text-gray-700 text-sm leading-relaxed font-montserrat mb-2">
                 "{review.text}"
               </p>
                 ...
                 {index === reviews.length - 1 && (
                      ...
                      className="inline-flex items-center gap-1 text-purple-600 hover:text-purple-700 font-semibold text-sm font-montserrat transition-colors"
                    >
                      Смотреть все отзывы
